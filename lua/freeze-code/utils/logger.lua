...
function M.err(msg)
  vim.notify(msg, vim.log.levels.ERROR, { title = "FreezeCode" })
end

---Display error message once
---@param msg string: Message to display
function M.err_once(msg)
  vim.notify_once(msg, vim.log.levels.ERROR, { title = "FreezeCode" })
end

---Display warn message
---@param msg string: Message to display
function M.warn(msg)
  vim.notify(msg, vim.log.levels.WARN, { title = "FreezeCode" })
end

---Display log message
---@param msg string: Message to display
function M.info(msg)
  vim.notify(msg, vim.log.levels.INFO, { title = "FreezeCode" })
end
...
function M.err_fmt(msg, ...)
  vim.notify(string.format(msg, ...), vim.log.levels.ERROR, { title = "FreezeCode" })
end
...
function M.err_once_fmt(msg, ...)
  vim.notify_once(string.format(msg, ...), vim.log.levels.ERROR, { title = "FreezeCode" })
end
...
function M.warn_fmt(msg, ...)
  vim.notify(string.format(msg, ...), vim.log.levels.WARN, { title = "FreezeCode" })
end
...
function M.info_fmt(msg, ...)
  vim.notify(string.format(msg, ...), vim.log.levels.INFO, { title = "FreezeCode" })
end
